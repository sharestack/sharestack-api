...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'machines_instance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('stack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['machines.Stack'])),
        ))
        db.send_create_signal(u'machines', ['Instance'])


    def backwards(self, orm):
        # Deleting model 'Instance'
        db.delete_table(u'machines_instance')
    ...
    models = {
        ...
        u'members.user': {
            ...
            'activation_token': ('django.db.models.fields.CharField', [], {'default': "'8dda9336-d955-4f4a-b297-ecb511b456ae'", 'max_length': '40', 'blank': 'True'}),
            ...
            'reset_password_token': ('django.db.models.fields.CharField', [], {'default': "'1894d2e1-fe08-4b58-9645-50317aa5f52f'", 'max_length': '40', 'blank': 'True'}),
